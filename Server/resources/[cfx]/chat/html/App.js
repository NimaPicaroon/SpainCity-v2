window.APP = {
  ...
  watch: {
    messages() {
      ...
      document.getElementById('img_defcon').classList.add('defconreducida');
  ...
  methods: {
    ...
    Poner({niveldefcon})
    {
      document.getElementById('img_defcon').src = 'defcon' + niveldefcon + '.png';
    ...
    {
      document.getElementById('img_disponibilidad').src = 'disponibilidad' + disponibles + '.png';
    ...
    resetShowWindowTimer() {
      ...
      this.showWindowTimer = setTimeout(() => {
        if (!this.showInput) {
          ...
          document.getElementById('img_defcon').classList.remove('defconreducida');
