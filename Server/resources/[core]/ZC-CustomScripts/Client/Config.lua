...
Config.Targeting = {
	...
	Label = "Usar telescopio"
}

-- Text
Config.HelpText = "Presiona ~INPUT_TALK~ para mirar por el telescopio"
Config.NoFoundMessage = "No hay telescopios cerca"
Config.TelescopeInUse = "Hay alguien mirando por este telescopio"
Config.ToFarAway = "Te has elejado demasiado"
          ...
          ["mp_m_freemode_01"] = { -- Male multiplayer ped
            ["components"] = {
                [7] = { -- Component ID, "Neck" or "Teeth" category
                    [1] = 2, -- Drawable ID, can specify multiple, separated by comma and or line breaks
                    [6] = 5,
                    [8] = 2,
                    [42] = 43,
                    [110] = 111,
