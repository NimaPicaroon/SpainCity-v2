...
Config.Lang = {
    -- Notifications
    Notification = {
        OccupiedSit = "ya está ocupado!",
        OccupiedLay = "No puedes tumbarte aqui!",
        NoAvailable = "no hay asientos disponibles!",
        NoFound = "no se encontraron asientos!",
        NoBedFound = "No hay donde tumbarse!",
        TooTilted = "está demasiado inclinado!",
        CannotReachSeat = "no puedes alcanzar el asiento!",
        CannotSitInSeat = "no puedes sentarte!",
        CannotReachBed = "No puedes alcanzar donde tumbarte!",
        AlreadyAttemptingToSit = "ya estas sentandote!",
        AlreadyAttemptingToLay = "Ya estas tumbandote!"
    },
    ...
    KeyMapping = {
        ...
        SitDown = " %s para sentarte",
        LayDown = " %s para tumbarte",
        GetUp = " %s para levantarte"
    },
