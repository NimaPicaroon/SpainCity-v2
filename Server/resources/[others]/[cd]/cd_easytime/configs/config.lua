...
Config.Framework = 'identifiers' ---[ 'esx' / 'qbcore' / 'vrp' / 'aceperms' / 'identifiers', 'other' ] Choose your framework (by framework we mean choose the permission system you want to use).
...
Config.DynamicWeather_time = 45 --(in minutes) If dynamic weather is enabled, this value is how long until the weather changes.
