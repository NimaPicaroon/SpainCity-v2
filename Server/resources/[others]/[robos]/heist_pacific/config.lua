...
Config['PacificHeist'] = {
    ...
    ['startHeist'] ={ -- heist start coords
        pos = vector3(235.31, 216.98, 106.29),
        peds = {
...
Config['PacificSetup'] = {
    ...
    ['trollys'] = { -- you can add new trolly but dont change first 4 trolly because for this extended vault fixed trollys
        {model = 'hei_prop_heist_cash_pile', pos = vector3(266.334, 255.849, 101.691), heading = nil},
        {model = 'hei_prop_heist_cash_pile', pos = vector3(269.230, 254.744, 101.691), heading = nil},
        {model = 'hei_prop_heist_cash_pile', pos = vector3(268.085, 251.274, 101.723), heading = nil},
        {model = 'hei_prop_heist_cash_pile', pos = vector3(266.076, 252.015, 101.691), heading = nil},
        
        {model = 'hei_prop_heist_cash_pile',  pos = vector3(266.351, 215.192, 100.683), heading = 115.0},
        {model = 'hei_prop_heist_cash_pile',     pos = vector3(265.107, 211.960, 100.683), heading = 35.0},
        {model = 'hei_prop_heist_cash_pile', pos = vector3(261.623, 213.510, 100.683), heading = 300.0},
        {model = 'hei_prop_heist_cash_pile',  pos = vector3(262.819, 216.429, 100.683), heading = 200.0},
    },
    ['stacks'] = {
        ...
        {model = 'h4_prop_h4_cash_stack_01a', pos = vector3(250.019, 247.602, 101.581), heading = 70.0},
        {model = 'h4_prop_h4_cash_stack_01a', pos = vector3(251.988, 252.979, 101.581), heading = 70.0},
    },
    ['glassCutting'] = {
