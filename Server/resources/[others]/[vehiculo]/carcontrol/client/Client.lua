...
ctrl.update = function()    
    ...
    RegisterKeyMapping('carcontrol', 'Abrir control de vehículo', 'keyboard', 'B')
...
ctrl.setEngine = function(d,s)
    ...
    if GetIsVehicleEngineRunning(v) then
       -- exports['mythic_notify']:SendAlert('info', 'Motor apagado', 2500)
        SetVehicleEngineOn(v, false, false)
    else
       -- exports['mythic_notify']:SendAlert('info', 'Motor Encendido', 2500)
