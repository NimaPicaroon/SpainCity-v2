...
Config.Item.Inventory = "qb_inventory" --[[
...
Config.Companies.Services = {
    {
        job = "police",
        name = "CNP",
        icon = "https://media.discordapp.net/attachments/831490177104478208/1096498522628563004/oposicion-policia-nacional-2021-santander.png",
        canCall = true, -- if true, players can call the company
        canMessage = true, -- if true, players can message the company
        bossRanks = {"comisarioprincipal"}, -- ranks that can manage the company
        location = {
            name = "Mission Row",
            coords = {
                x = 428.9,
...
Config.Locations = { -- Locations that'll appear in the maps app.
    {
        ...
        name = "CNP",
        description = "Comisaria de Mission Row",
...
Config.PhoneNumber = {}
Config.PhoneNumber.Format = "{3} {2} {2} {2}" -- Don't touch unless you know what you're doing. IMPORTANT: The sum of the numbers needs to be equal to the phone number length
