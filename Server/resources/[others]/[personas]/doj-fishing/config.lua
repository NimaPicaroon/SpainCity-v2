...
Config.FishingWaitTime = {minTime = 5000, maxTime = 35000}     -- How long a player will be waiting to fish, during or after casting fishingrod
...
Config.PearlsSellsBlip = vector3(-1820.5984, -1255.4381, 13.0174)  -- Blip to sell fish you have caught
...
Config.codfishPrice      = 8                                   -- Price of Cod
Config.bassPrice         = 15                                   -- Price of Normal Fish
Config.flounderPrice     = 20                                   -- Price of Flounder
Config.stingrayPrice     = 25                                   -- Price of Stingrays

-- Exotic Fish
Config.dolphinPrice      = 25                                  -- Price of Dolphins
Config.sharktigerPrice   = 40                                  -- Price of Tigersharks
Config.sharkhammerPrice  = 50                                  -- Price of Hammerhead Sharks
Config.killerwhalePrice  = 75                                  -- Price of Killer whales

-- Rewards
Config.smallLootboxCash = math.random(50,125)                                  	-- Price of the cash reward for the "Metal Box"
Config.smallLootboxReward = {
	'esmerald_ring',
	'turquese_ring',
	'jacinth_ring',
	'fishingtin',
...
Config.largeLootboxRewardSlot = 4
-- Config.largeLootboxRewards = {                                  -- Rewards found in the treasure chest (keep price = 0)
--     [1] = { name = "esmerald_ring", price = 0, amount = 1, info = {}, type = "item", slot = 1, },
-- 	[2] = { name = "turquese_ring", price = 0, amount = 1, info = {}, type = "item", slot = 2, },
--     [3] = { name = "jacinth_ring", price = 0, amount = 1, info = {}, type = "item", slot = 3, },
--     [4] = { name = "jacinth_necklace", price = 0, amount = 1, info = {}, type = "item", slot = 4, },
--     [5] = { name = "turquese_necklace", price = 0, amount = 1, info = {}, type = "item", slot = 5, },
...
Config.PedList = {                                              -- Peds that will be spawned in (if you change a ped model here you need to also change the ped model in client/addons.lua qb-target exports)
	...
	-- },
	{
		model = "a_m_m_bevhills_01",                            -- Boat/Gear Menu
		coords = vector3(436.93, 6452.62, 27.78),               
		heading = 344.111,
		gender = "male",
        scenario = "WORLD_HUMAN_CLIPBOARD_FACILITY"
	},
	{
		model = "a_m_m_bevhills_01",                            -- casa alien
		coords = vector3(1383.32, 2176.26, 96.85),               
		heading = 71.786,
		gender = "male",
        scenario = "WORLD_HUMAN_CLIPBOARD"
	},
	--{
	--	model = "a_m_m_bevhills_01",                            -- Plantación marihuana
	--	coords = vector3(1030.65, -3205.58, -39.2),               
	--	heading = 240.693,
	--	gender = "male",
    --    scenario = "WORLD_HUMAN_CLIPBOARD_FACILITY"
	--},
    {
		...
		coords = vector3(-1820.5984, -1255.4381, 12.0174),         -- Regular/Exotic Fish Sells
		heading = 325.172,
		gender = "male",
        scenario = "WORLD_HUMAN_CLIPBOARD"
	},
